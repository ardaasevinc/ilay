...
(function ($) {
        ...
        $(".tj-quick-product-details").on("click", function () {
            ...
            setTimeout(function () {
                ...
                if ($(".tj-quick-details-slider").length > 0) {
                    window.quickSwiper = new Swiper(
                        ".tj-quick-details-slider",
                        {
                            slidesPerView: 1,
                            loop: true,
                            speed: 1200,
        ...
        function initStickyAndProgress() {
            mediaMatch.add("(min-width: 0)", () => {
                ...
                if ($(".tj-sticky-panel-2").length > 0) {
                    let tl = gsap.timeline();
                    let panels =
                        document.querySelectorAll(".tj-sticky-panel-2");
        ...
        function sidebarStickyController() {
            ...
            if (containers.length) {
                containers.forEach((container) => {
                    const panels =
                        container.querySelectorAll(".slidebar-stickiy");
                    if (panels.length) {
                        mediaMatch.add("(min-width: 992px)", () => {
    ...
    if ($(".tj-hover-active-item").length) {
        const allHoverItems = document.querySelectorAll(
    ...
    function hoverWidget_animation() {
        ...
        $(".tj-active-bg-wrapper .tj-active-bg-item").on(
            "mouseenter",
            function () {
                let e = $(this);
        ...
        $(".tj-active-bg-wrapper .tj-active-bg-item").on("click", function () {
            $(".tj-active-bg-wrapper .tj-active-bg-item").removeClass(
                "current"
            );
